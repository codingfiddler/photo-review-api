...
class CustomUser(AbstractUser):
    ...
    bio = models.TextField(max_length = 250, blank=True, help_text='Write something cool!')
...
class UploadedPhoto(models.Model):
    ...
    location_taken = models.CharField(max_length = 100, help_text="Earth, Orion Arm")
    ...
    software_used = models.TextField(max_length = 250, blank=True, null=True)
